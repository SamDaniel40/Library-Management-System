<%@ Page Title=" User Homepage" Language="C#" MasterPageFile="~/UserScreen/User.Master" AutoEventWireup="true" CodeFile="UserHome.aspx.cs" Inherits="UserScreen_UserHome" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h3>Welcome to User's Homepage</h3>
    <div class="row">
