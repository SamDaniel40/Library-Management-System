<%@ Page Title="Admin Homepage" Language="C#" MasterPageFile="~/AdminScreen/Admin.Master" AutoEventWireup="true" CodeFile="AdminHome.aspx.cs" Inherits="AdminScreen_AdminHome" %>
    ...
    <div class="row">
        <div class="col-lg-4 mb-4">
            ...
            <div class="card h-100 border-start-lg border-start-primary">
                <div class="card-body">
                    <div class="small text-muted">Current Issued Books</div>
                    <div class="h3">
                        <asp:Label ID="lblIssuebook" runat="server" Text="Label"></asp:Label>
                    </div>
